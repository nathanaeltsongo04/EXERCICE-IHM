...
<html class="no-js" lang="en">
    ...
    ?>
        ...
        Swal.fire({
            ...
            location.replace('utilisateur.php');
        });
        </script>
        <?php } ?>
        <!--[if lt IE 8]>
                            ...
                            <div class="card-body">
                                <div class=" container table-responsive">
                                    <table id="order-table" class="table table-striped  nowrap">
                                        ...
                                        ?>
                                            <tr>
                                                <td><b><?= $val['CODEUTILISATEUR'] ?></b></td>
                                                <td><b><?= $val['NOM'] . " " . $val['POSTNOM'] . " " . $val['PRENOM'] ?></b>
                                                </td>
                                                <td><b><?= $val['SERVICE'] ?></b></td>
                                                <td><span data-id='<?= $val['CODEUTILISATEUR'] ?>'
                                                        class="badge elementinfo "><i
                                                            class="fa fa-edit fa-xl text-success" data-toggle="tooltip"
                                                            data-placement="top"
                                                            title="Modifier cet élément"></i></span>
                                                    <span data-id='<?= $val['CODEUTILISATEUR'] ?>'
                                                        class="badge elementinfo "><i
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Nouveau Utilisateur</h5>
                                                ...
                                                <div class=" col-md-10 form-group mt-2 ">
                                                    <div class="input-group has-validation">
                                                        <input type="text" name="postnom" class="form-control"
                                                            id="postnomm" placeholder="Post Nom" required>
                                                    </div>
                                                </div>
                                                <div class=" col-md-10 form-group mt-2 ">
                                                    <div class="input-group has-validation">
                                                        <input type="text" name="prenom" class="form-control"
                                                            id="prenom" placeholder="Prénom" required>
                                                    </div>
                                                </div>
                                                <div class=" col-md-10 form-group mt-2 ">
                                                    <div class="input-group has-validation">
        ...
        <div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Modifer Utilisateur</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        $(document).ready(function() {
            $('.elementinfo').click(function() {
                var codeutilisateur = $(this).data('id');

                $.ajax({
                    url: '../process/Load/LdUtilisateur.php',
                    type: 'POST',
                    data: {
