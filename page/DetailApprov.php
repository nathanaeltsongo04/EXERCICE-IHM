                        ...
                        <div class="card-header row">
                            ...
                            <div class="col col-sm-12">
                                ...
                                <div class=" float-right px-4">
                                    ...
                                    <a class="text-primary mr-2 " href="" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa solid fa-plus-circle fa-xl">
                                        </i> <span><b>Approvisionner
                                            </b>
                                        </span></a>
                                    <a class="text-secondary" href="../page/DetailApprov.php "><i class="fa solid fa-file fa-xl"> </i> <span><b>Details Approvisionnements
                                            </b>
                                        </span></a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><span data-id='<?= $val['id_detailApprovisionnement'] ?>' class="badge elementinfo "><i class="fa fa-edit fa-xl text-success " data-toggle="tooltip" data-placement="top" title="Modifier cet élément"></i></span>
                                                    <span data-id='<?= $val['id_detailApprovisionnement'] ?>' class="badge elementinfo "><i class="fa fa-trash-can fa-xl text-danger " data-toggle="tooltip" data-placement="top" title="Supprimer cet élément"></i></span>
                                                </td>
                                            </tr>
                                        <?php
                                            $numero++;
                            ...
                            <div class="row">
                                <div class="modal-body">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class=" col-md-6 form-group mt-3 ">
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" placeholder="Quantité" required id="quantite" name="quantite">
                                            </div>
                                        </div>
                                        <div class=" col-md-6 form-group mt-3 ">
                                            <div class="input-group has-validation">
                                                <input type="text" class="form-control" placeholder="Prix unitaire" required id="prixun" name="prixun">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-md-12 text-center">
                                        <button name="saveDetail" class="btn btn-primary w-50 fw-bold" type="submit">Enregistrer</button>
                                    </div>
                                </div>
                            </div>
                        </div>
